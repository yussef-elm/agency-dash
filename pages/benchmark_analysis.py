...
from charts import create_performance_heatmap
from components import display_benchmark_analysis_cards
...
def show(selected_centers, start_date, end_date):
    ...
    fig = create_performance_heatmap(valid_results)
    st.plotly_chart(fig, use_container_width=True)

    display_benchmark_analysis_cards(valid_results)
